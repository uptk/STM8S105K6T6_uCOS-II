...
typedef unsigned char   OS_CPU_SR;                               /* Define size of CPU status register (PSR = 8 bits)   */
...
@far void       OSCtxSw(void);
@far void       OSIntCtxSw(void);
@far void       OSStartHighRdy(void);
